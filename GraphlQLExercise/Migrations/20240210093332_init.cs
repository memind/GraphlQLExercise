...
namespace GraphlQLExercise.Migrations
{
    /// <inheritdoc />
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "John Doe", "johndoe@example.com", 2, "555-123-4567", new DateTime(2024, 2, 17, 12, 33, 32, 749, DateTimeKind.Local).AddTicks(5787), "No nuts in the dishes, please." },
                    { 2, "Jane Smith", "janesmith@example.com", 4, "555-987-6543", new DateTime(2024, 2, 20, 12, 33, 32, 749, DateTimeKind.Local).AddTicks(5805), "Gluten-free options required." },
                    { 3, "Michael Johnson", "michaeljohnson@example.com", 6, "555-789-0123", new DateTime(2024, 2, 24, 12, 33, 32, 749, DateTimeKind.Local).AddTicks(5807), "Celebrating a birthday." }
                });
