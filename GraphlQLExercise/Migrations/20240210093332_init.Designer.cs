...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraphlQLExercise.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GraphlQLExercise.Models.Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GraphlQLExercise.Models.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReservationDate = new DateTime(2024, 2, 17, 12, 33, 32, 749, DateTimeKind.Local).AddTicks(5787),
                        ...
                        new
                        {
                            ...
                            ReservationDate = new DateTime(2024, 2, 20, 12, 33, 32, 749, DateTimeKind.Local).AddTicks(5805),
                        ...
                        new
                        {
                            ...
                            ReservationDate = new DateTime(2024, 2, 24, 12, 33, 32, 749, DateTimeKind.Local).AddTicks(5807),
            ...
            modelBuilder.Entity("GraphlQLExercise.Models.Menu", b =>
                {
                    b.HasOne("GraphlQLExercise.Models.Category", null)
                        .WithMany("Menus")
